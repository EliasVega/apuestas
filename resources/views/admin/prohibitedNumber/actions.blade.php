@can('prohibitedNumber.edit')
    <a href="{{ route('prohibitedNumber.edit', $id) }}" class="btn btn-warning btn-sm"
    data-toggle="tooltip" data-placement="top" title="Editar"><i class="far fa-edit"></i></a>
@endcan
@can('prohibitedNumber.destroy')
...
@endcan
@include('admin.prohibitedNumber.delete', ['id' => $id])
